...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_596157c52999c014, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_596157c52999c014, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "sourcehub.sourcehub.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "sourcehub.sourcehub.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("sourcehub/sourcehub/tx.proto", fileDescriptor_596157c52999c014) }

var fileDescriptor_596157c52999c014 = []byte{
	// 337 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x29, 0xce, 0x2f, 0x2d,
	0x4a, 0x4e, 0xcd, 0x28, 0x4d, 0xd2, 0x47, 0xb0, 0x4a, 0x2a, 0xf4, 0x0a, 0x8a, 0xf2, 0x4b, 0xf2,
	...
	0xab, 0xa4, 0x58, 0x1b, 0x40, 0xde, 0x71, 0xf2, 0x3b, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39,
	0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63,
	0x39, 0x86, 0x28, 0x93, 0xf4, 0xcc, 0x12, 0x90, 0x01, 0xc9, 0xf9, 0xb9, 0x50, 0xcf, 0xe4, 0xa5,
	0x96, 0x94, 0xe7, 0x17, 0x65, 0xeb, 0x63, 0xf7, 0x66, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b,
	0x38, 0xa6, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xfd, 0xb3, 0x88, 0xe2, 0x5d, 0x02, 0x00,
	0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sourcehub.sourcehub.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sourcehub.sourcehub.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "sourcehub.sourcehub.Msg",
	...
	Metadata: "sourcehub/sourcehub/tx.proto",
}
