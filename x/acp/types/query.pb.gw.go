...
var (
	...
	pattern_Query_PolicyIds_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"sourcenetwork", "sourcehub", "acp", "policy_i_ds"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_FilterRelationships_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sourcenetwork", "sourcehub", "acp", "filter_relationships", "policyId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_VerifyAccessRequest_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"sourcenetwork", "sourcehub", "acp", "verify_access_request", "policyId"}, "", runtime.AssumeColonVerbOpt(false)))
)
