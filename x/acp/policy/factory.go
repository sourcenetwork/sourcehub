...
func (f *factory) Create(polStr string, t types.PolicyMarshalingType, creator string, sequence uint64, creationTime *gogotypes.Timestamp) (*types.PolicyRecord, error) {
