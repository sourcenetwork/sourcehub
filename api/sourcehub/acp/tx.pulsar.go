...
var file_sourcehub_acp_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_sourcehub_acp_tx_proto_depIdxs = []int32{
	2, // 0: sourcehub.acp.MsgUpdateParams.params:type_name -> sourcehub.acp.Params
	0, // 1: sourcehub.acp.Msg.UpdateParams:input_type -> sourcehub.acp.MsgUpdateParams
	1, // 2: sourcehub.acp.Msg.UpdateParams:output_type -> sourcehub.acp.MsgUpdateParamsResponse
